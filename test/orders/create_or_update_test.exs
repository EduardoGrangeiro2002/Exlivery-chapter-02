defmodule Exlivery.Orders.CreateOrUpdateTest do
  ...
  describe "call/1" do
    ...
    test "when there  are invalid items, return an error", %{user_cpf: cpf, item1: item1, item2: item2, } do
    ...
    test "when there are no items, return an error", %{user_cpf: cpf, item1: item1, item2: item2, } do
